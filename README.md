...
**Current build:** `Apex Build 1.7.6`
...
## What is new in Apex Build 1.7.6

- **Rotate prompt fixed** - Mega Plot portrait mode keeps the ASCII phone graphic upright and readable.
- **Animation simplified** - only the rotate cue moves, avoiding the broken diagonal art effect.
- **In-app documentation updated** - About, Change Log modals, build labels, and cache-bust query strings now show Apex Build 1.7.6.
