...
**Current build:** `Apex Build 1.7.9`
...
## What is new in Apex Build 1.7.9

- **Proper rotate animation** - Mega Plot portrait mode now uses a smooth animated phone graphic instead of ASCII art.
- **Centered motion** - the phone rotates from portrait to landscape around the center of the prompt.
- **Crop preview retained** - Mega Plot time cropping keeps the permanent lightweight visual preview.
- **In-app documentation updated** - About, Change Log modals, build labels, and cache-bust query strings now show Apex Build 1.7.9.
